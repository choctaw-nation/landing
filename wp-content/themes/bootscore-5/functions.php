...
if ( ! function_exists( 'bootscore_setup' ) ) :
	...
	function bootscore_setup() {
		 ...
		 * Add Image Size
		 */
		add_image_size( 'carousel', 500, 1200 );
		add_image_size( 'carousel-expand', 1200, 2000 );
...
function bootscore_scripts() {
	...
	// Bootstrap
	wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/css/lib/bootstrap.min.css', array(), '5.0.1' );

	// Style CSS
	wp_enqueue_style( 'bootscore-style', get_stylesheet_uri(), array( 'bootstrap', 'fontawesome' ), time() );

	// Fontawesome
	wp_enqueue_style( 'fontawesome', get_template_directory_uri() . '/css/lib/fontawesome.min.css' );

	// Bootstrap JS
	wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/js/lib/bootstrap.bundle.min.js', array( 'jquery' ), '20151215', array( 'strategy' => 'defer' ) );

	// Theme JS
	wp_enqueue_script( 'bootscore-script', get_template_directory_uri() . '/js/theme.js', array( 'bootstrap' ), '20151215', array( 'strategy' => 'defer' ) );
...
// Remove editor from the News custom post type
