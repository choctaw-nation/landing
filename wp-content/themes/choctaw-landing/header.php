		...
		<div class="header-bar position-relative">
			...
			<nav id="nav-main" class="navbar navbar-expand-lg">
				<div class="container-xl">
					<a class="navbar-brand" href="<?php echo user_trailingslashit( esc_url( home_url() ) ); ?>">
						<img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/img/logo/logo-v2.svg' ); ?>" alt="Choctaw Landing Logo" class="logo" data-spai-eager loading="eager">
					</a>
