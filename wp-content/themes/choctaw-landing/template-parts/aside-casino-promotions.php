            ...
            <div class="col-10 swiper">
                <div class="swiper-wrapper align-items-stretch h-100">
                    ...
                    <div class="swiper-slide h-100">
                        <div class="card bg-dark text-white d-flex flex-column">
                            ...
                            <div class="card-body m-4 d-flex flex-column">
                                ...
                                <a href="<?php echo $promotion['link']; ?>" class="btn btn-outline-light mt-auto align-self-start" target="_blank">Learn More</a>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; ?>
