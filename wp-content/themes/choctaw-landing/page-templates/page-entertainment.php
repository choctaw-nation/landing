...
<div id="header-img" class="container-fluid gx-0">
  <img src="/wp-content/uploads/2023/09/entertainment-header.jpg" alt="Entertainment Header" class="w-100" />
</div>
...
<div id="amenities-header" class="container-fluid my-5" style="background: url('/wp-content/uploads/2023/09/banner-bg.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat;">
  <div class="container">
    <div class="row">
  ...
  <div class="row align-items-center pt-2 pb-5">
    ...
    <div class="col-12 col-lg-7">
      <div class="row position-relative">
        ...
        <div class="col-12 col-md-9 col-xl-10">
          <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum.</p>
          <p class="py-4 d-none d-md-block"><img src="/wp-content/uploads/2023/08/double-arrow.svg" class="arrow position-absolute" /><a href="#" download class="arrow-link">Learn More</a></p>
