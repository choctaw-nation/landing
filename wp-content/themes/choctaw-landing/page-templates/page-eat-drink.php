...
<div id="header-img" class="container-fluid gx-0">
  <img src="/wp-content/uploads/2023/09/eat-and-drink-header.jpg" alt="Eat & Drink Header" class="w-100" />
</div>
      ...
      <div class="row position-relative">
        ...
        <div class="col-12 col-md-9 col-xl-10">
          <div class="row">
            ...
            <div class="col"><i class="fas fa-dollar-sign"></i><i class="fas fa-dollar-sign"></i><i class="fas fa-dollar-sign opacity-25"></i><i class="fas fa-dollar-sign opacity-25"></i></div>
          </div>
          <hr class="my-4" />
          ...
          <hr class="my-4" />
          <p class="py-4 d-none d-md-block"><img src="/wp-content/uploads/2023/08/double-arrow.svg" class="arrow position-absolute" /><a href="#" class="arrow-link">Make Reservations</a> | <a href="#" class="arrow-link">Order Online</a></p>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-12 col-lg-4 px-4 py-5">
        ...
        <div class="row">
          <div class="col">American Variety</div>
          <div class="col"><i class="fas fa-dollar-sign"></i><i class="fas fa-dollar-sign opacity-25"></i><i class="fas fa-dollar-sign opacity-25"></i><i class="fas fa-dollar-sign opacity-25"></i></div>
        </div>
      </div>
      <div class="col-12 col-lg-4 px-4 py-5">
