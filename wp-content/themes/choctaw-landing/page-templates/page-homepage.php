    ...
    <div class="col-12 col-lg-7">
      <div class="row position-relative">
        ...
        <div class="col-12 col-md-9 col-xl-10">
          ...
          <p class="py-4 d-none d-md-block"><img src="/wp-content/uploads/2023/08/double-arrow.svg" class="arrow position-absolute" /><a href="#" download class="arrow-link">Plan Your Trip</a></p>
...
<div id="adventure" class="container-fluid py-5" style="background: url('/wp-content/uploads/2023/08/adventure-home-bg.jpg'); background-position:bottom; background-repeat: no-repeat; background-size: cover;">
    ...
    <div class="row py-5">
      <div class="col-12 col-xl-7">
        ...
        <div class="row position-relative">
          ...
          <div class="col-9 col-lg-10">
            <p class="text-light">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.</p>
            <p class="py-4 d-none d-md-block text-light"><img src="/wp-content/uploads/2023/08/double-arrow.svg" class="arrow arrow-white position-absolute" /><a href="#" download class="arrow-link arrow-link-white">Start Your Adventure</a></p>
    ...
    <div class="col-12 col-lg-7 order-2 order-lg-1">
      <div class="row position-relative">
        ...
        <div class="col-12 col-md-9 col-xl-10">
          ...
          <p class="py-4 d-none d-md-block"><img src="/wp-content/uploads/2023/08/double-arrow.svg" class="arrow position-absolute" /><a href="#" download class="arrow-link">Try Your Luck</a></p>
