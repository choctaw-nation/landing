...
<div id="luxury" class="container my-5">
	<div class="row justify-content-center pt-2 pb-5">
		<div class="col-10 text-center">
			...
			<p>Get ready for a new resort experience coming soon to Hochatown, OK. Located less than an hour north of the Oklahoma/Texas border, Choctaw Landing promises to be the hub of
				Broken Bow-area entertainment.</p>
		</div>
	</div>
</div>
		...
		<div class="col-12 col-lg-7 order-2 order-lg-1">
			<div class="row position-relative">
				...
				<div class="col-12 col-md-9 col-xl-10">
					...
					<p class="py-4 d-none d-md-block"><img src="/wp-content/uploads/2023/08/double-arrow.svg" class="arrow position-absolute" /><a href="#" download class="arrow-link">Book
		...
		<div class="col-12 col-lg-7 order-2 order-lg-1">
			<div class="row position-relative">
				...
				<div class="col-12 col-md-9 col-xl-10">
					<p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos
						et accusam et justo duo dolores et ea rebum.</p>
					<p class="py-4 d-none d-md-block"><img src="/wp-content/uploads/2023/08/double-arrow.svg" class="arrow position-absolute" /><a href="#" download class="arrow-link">Check
							Out Our Gym</a></p>
