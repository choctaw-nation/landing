...
class Hero_Section extends Generator {
	...
	private function handle_video_params() {
		...
		$attributes  = 'frameborder="0" autoplay muted allow="autoplay"';
	...
	public function get_the_hero(): string {
		...
		$markup   = "<header id='header-img' class='hero container-fluid gx-0 position-relative'><div class='ratio ratio-16x9'>{$this->video}</div>{$headline}</header>";
		return $markup;
	}
